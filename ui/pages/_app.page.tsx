...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp | storms24</title>
        <meta name="description" content="ZkApp By storms24" />
		<meta name="viewport" content="width=1024"/>
        <link href="data:image/png;base64,=" rel="icon" type="image/x-icon" />
	  </Head>
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/storms24" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/storms24" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/storms24" target="_blank" rel="noopener noreferrer" >
